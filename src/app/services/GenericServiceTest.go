...
//GenericServiceTest generic service structure for IEntityModel
...
//NewGenericServiceTest generic service constructor
//Params
...
func (s *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) log(ctx context.Context, level, message string) {
...
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) excludeDeleted(queryBuilder interfaces.IQueryBuilder) {
...
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) addSearchInAllFields(search string, queryBuilder interfaces.IQueryBuilder) {
...
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) GetList(ctx context.Context, search, orderBy, orderDirection string, page, pageSize int) (*dtos.PaginatedListDto[DtoType], error) {
	pageFinal := page
...
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) getByIdExcludeDeleted(ctx context.Context, id uuid.UUID) (*EntityType, error) {
...
//	error - if an error occurs, otherwise nil
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) GetById(ctx context.Context, id uuid.UUID) (*DtoType, error) {
...
//Return
//	error - if an error occurs, otherwise nil
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) Update(ctx context.Context, updateDto UpdateDtoType, id uuid.UUID) error {
	entity, err := ges.getByIdExcludeDeleted(ctx, id)
	if err != nil {
		return err
	}
...
//	error - if an error occurs, otherwise nil
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) Create(ctx context.Context, createDto CreateDtoType) (uuid.UUID, error) {
...
//Return
//	error - if an error occurs, otherwise nil
func (ges *GenericServiceTest[DtoType, CreateDtoType, UpdateDtoType, EntityType]) Delete(ctx context.Context, id uuid.UUID) error {
	entity, err := ges.getByIdExcludeDeleted(ctx, id)
	if err != nil {
		return err
	}
